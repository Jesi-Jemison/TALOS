...
def build_evidence_readme(
    ...
    lines = [
        ...
        "",
        "The watch is complete. The source remains sealed; approved changes affect only the working copy.",
        "Findings are contextual signals under TALOS's documented checks, not proof of data correctness.",
        "Source preserved · Repairs recorded · Nothing changed without approval",
        "",
        "FILES",
        "-----",
    ]
